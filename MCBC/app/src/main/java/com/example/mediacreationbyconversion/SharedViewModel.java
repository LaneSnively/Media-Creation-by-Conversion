...
public class SharedViewModel extends ViewModel {
    ...
    public void setPaint(Paint data) {
        this.paint.setValue(data);
    }
    ...
    public void setCanvas(Canvas data) {
        this.canvas.setValue(data);
    }
    ...
    public void setHistory(List<Bitmap> data) {
        this.history.setValue(data);
    }

    public LiveData<List<Bitmap>> getHistory() {
        return history;
    }

    private MutableLiveData<Integer> brushSize = new MutableLiveData<>();

    public void setBrushSize(Integer data) {
        this.brushSize.setValue(data);
    }

    public LiveData<Integer> getBrushSize() {
        return brushSize;
    }

    private MutableLiveData<String> brushShape = new MutableLiveData<>();

    public void setBrushShape(String data) {
        this.brushShape.setValue(data);
    }

    public LiveData<String> getBrushShape() {
        return brushShape;
    }

    private MutableLiveData<Float> canvasX = new MutableLiveData<>();

    public void setCanvasX(Float data) {
        this.canvasX.setValue(data);
    }

    public LiveData<Float> getCanvasX() {
        return canvasX;
    }

    private MutableLiveData<Float> canvasY = new MutableLiveData<>();

    public void setCanvasY(Float data) {
        this.canvasY.setValue(data);
    }

    public LiveData<Float> getCanvasY() {
        return canvasY;
    }
    ...
    public void setCanvasColor(Integer data) {
        this.canvasColor.setValue(data);
    }

    public LiveData<Integer> getCanvasColor() {
        return canvasColor;
    }
}
